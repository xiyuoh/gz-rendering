...
#include "ignition/rendering/ogre/OgreMovableText.hh"
...
class ignition::rendering::OgreMovableTextPrivate
{
  ...
  public: OgreMovableText::VertAlign vertAlign = OgreMovableText::V_BELOW;

  /// \brief Horizontal alignment
  public: OgreMovableText::HorizAlign horizAlign = OgreMovableText::H_LEFT;
...
OgreMovableText::OgreMovableText()
    : dataPtr(new OgreMovableTextPrivate)
{
...
//////////////////////////////////////////////////
void OgreMovableText::Load(const std::string &_name,
...
//////////////////////////////////////////////////
void OgreMovableText::SetFontName(const std::string &_newFontName)
{
  std::lock_guard<std::recursive_mutex> lock(this->dataPtr->mutex);
...
//////////////////////////////////////////////////
const std::string &OgreMovableText::FontName() const
{
  return this->dataPtr->fontName;
}

//////////////////////////////////////////////////
void OgreMovableText::SetText(const std::string &newText)
{
  std::lock_guard<std::recursive_mutex> lock(this->dataPtr->mutex);
...
//////////////////////////////////////////////////
const std::string &OgreMovableText::Text() const
{
  return this->dataPtr->text;
}

//////////////////////////////////////////////////
void OgreMovableText::SetColor(const ignition::math::Color &_newColor) {
  std::lock_guard<std::recursive_mutex> lock(this->dataPtr->mutex);
...
//////////////////////////////////////////////////
const ignition::math::Color &OgreMovableText::Color() const
{
  std::lock_guard<std::recursive_mutex> lock(this->dataPtr->mutex);
...
//////////////////////////////////////////////////
void OgreMovableText::SetCharHeight(float _height)
{
  std::lock_guard<std::recursive_mutex> lock(this->dataPtr->mutex);
...
//////////////////////////////////////////////////
float OgreMovableText::CharHeight() const
{
  std::lock_guard<std::recursive_mutex> lock(this->dataPtr->mutex);
...
//////////////////////////////////////////////////
void OgreMovableText::SetSpaceWidth(float _width)
{
  std::lock_guard<std::recursive_mutex> lock(this->dataPtr->mutex);
...
//////////////////////////////////////////////////
float OgreMovableText::SpaceWidth() const
{
  std::lock_guard<std::recursive_mutex> lock(this->dataPtr->mutex);
...
//////////////////////////////////////////////////
void OgreMovableText::SetBaseline(float _base)
{
  std::lock_guard<std::recursive_mutex> lock(this->dataPtr->mutex);
...
//////////////////////////////////////////////////
float OgreMovableText::Baseline() const
{
  std::lock_guard<std::recursive_mutex> lock(this->dataPtr->mutex);
...
//////////////////////////////////////////////////
bool OgreMovableText::ShowOnTop() const
{
  std::lock_guard<std::recursive_mutex> lock(this->dataPtr->mutex);
...
//////////////////////////////////////////////////
ignition::math::AxisAlignedBox OgreMovableText::AABB()
{
  std::lock_guard<std::recursive_mutex> lock(this->dataPtr->mutex);
...
void OgreMovableText::SetupGeometry()
{
  ...
  for (i = this->dataPtr->text.begin(); i != this->dataPtr->text.end(); ++i)
  {
    ...
    //
    // Upper left
    if (this->dataPtr->horizAlign == OgreMovableText::H_LEFT)
      *pVert++ = left;
    else
      *pVert++ = left - (len/2.0);
