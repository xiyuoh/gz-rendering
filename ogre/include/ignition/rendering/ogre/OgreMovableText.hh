 ...
 *
*/
#ifndef IGNITION_RENDERING_OGRE_OGREMOVABLETEXT_HH_
#define IGNITION_RENDERING_OGRE_OGREMOVABLETEXT_HH_
...
namespace ignition
{
  namespace rendering
  {
      ...
      : public Ogre::MovableObject, public Ogre::Renderable
    {
      ...
      private: std::unique_ptr<OgreMovableTextPrivate> dataPtr;
    };
    }
  }
}
