...
#ifndef IGNITION_RENDERING_GZIFACE_SCENEMANAGER_HH_
#define IGNITION_RENDERING_GZIFACE_SCENEMANAGER_HH_
...
#include <ignition/rendering/gziface/Export.hh>
...
inline namespace IGNITION_RENDERING_VERSION_NAMESPACE {
  ...
  class IGNITION_RENDERING_GZIFACE_VISIBLE SceneManager
  {
    /// \brief Constructor
    public: SceneManager();
    ...
    public: VisualPtr CreateModel(uint64_t _id,
    ...
    public: VisualPtr CreateLink(uint64_t _id,
    ...
    public: VisualPtr CreateVisual(uint64_t _id,
    ...
    public: LightPtr CreateLight(uint64_t _id,
    ...
    public: NodePtr NodeById(uint64_t _id) const;
