...
class ignition::rendering::Ogre2MovableTextPrivate
{
  ...
  public: Ogre2MovableText::VertAlign vertAlign = Ogre2MovableText::V_BELOW;

  /// \brief Horizontal alignment
  public: Ogre2MovableText::HorizAlign horizAlign = Ogre2MovableText::H_LEFT;
  ...
  public: Ogre::v1::RenderOperation renderOp;
...
//////////////////////////////////////////////////
void Ogre2MovableText::Load(const std::string &_name,
...
//////////////////////////////////////////////////
void Ogre2MovableText::SetFontName(const std::string &_newFontName)
{
  std::lock_guard<std::recursive_mutex> lock(this->dataPtr->mutex);
...
//////////////////////////////////////////////////
const std::string &Ogre2MovableText::FontName() const
{
  return this->dataPtr->fontName;
}

//////////////////////////////////////////////////
void Ogre2MovableText::SetText(const std::string &newText)
{
  std::lock_guard<std::recursive_mutex> lock(this->dataPtr->mutex);
...
//////////////////////////////////////////////////
const std::string &Ogre2MovableText::Text() const
{
  return this->dataPtr->text;
}

//////////////////////////////////////////////////
void Ogre2MovableText::SetColor(const ignition::math::Color &_newColor) {
  std::lock_guard<std::recursive_mutex> lock(this->dataPtr->mutex);
...
//////////////////////////////////////////////////
const ignition::math::Color &Ogre2MovableText::Color() const
{
  std::lock_guard<std::recursive_mutex> lock(this->dataPtr->mutex);
...
//////////////////////////////////////////////////
void Ogre2MovableText::SetCharHeight(float _height)
{
  std::lock_guard<std::recursive_mutex> lock(this->dataPtr->mutex);
...
//////////////////////////////////////////////////
float Ogre2MovableText::CharHeight() const
{
  std::lock_guard<std::recursive_mutex> lock(this->dataPtr->mutex);
...
//////////////////////////////////////////////////
void Ogre2MovableText::SetSpaceWidth(float _width)
{
  std::lock_guard<std::recursive_mutex> lock(this->dataPtr->mutex);
...
//////////////////////////////////////////////////
float Ogre2MovableText::SpaceWidth() const
{
  std::lock_guard<std::recursive_mutex> lock(this->dataPtr->mutex);
...
//////////////////////////////////////////////////
void Ogre2MovableText::SetTextAlignment(const HorizAlign &h, const VertAlign &v)
{
  std::lock_guard<std::recursive_mutex> lock(this->dataPtr->mutex);
...
//////////////////////////////////////////////////
void Ogre2MovableText::SetBaseline(float _base)
{
  std::lock_guard<std::recursive_mutex> lock(this->dataPtr->mutex);
...
//////////////////////////////////////////////////
float Ogre2MovableText::Baseline() const
{
  std::lock_guard<std::recursive_mutex> lock(this->dataPtr->mutex);
...
//////////////////////////////////////////////////
bool Ogre2MovableText::ShowOnTop() const
{
  std::lock_guard<std::recursive_mutex> lock(this->dataPtr->mutex);
...
//////////////////////////////////////////////////
ignition::math::AxisAlignedBox Ogre2MovableText::AABB()
{
  std::lock_guard<std::recursive_mutex> lock(this->dataPtr->mutex);
...
void Ogre2MovableText::SetupGeometry()
{
  ...
  for (i = this->dataPtr->text.begin(); i != this->dataPtr->text.end(); ++i)
  {
    ...
    //
    // Upper left
    if (this->dataPtr->horizAlign == Ogre2MovableText::H_LEFT)
      *pVert++ = left;
    else
      *pVert++ = left - (len/2.0);
...
//////////////////////////////////////////////////
// const Ogre::AxisAlignedBox &Ogre2MovableText::getBoundingBox(void) const
//{
//  std::lock_guard<std::recursive_mutex> lock(this->dataPtr->mutex);
...
//////////////////////////////////////////////////
//float Ogre2MovableText::getSquaredViewDepth(const Ogre::Camera * /*cam_*/) const
//{
//  std::lock_guard<std::recursive_mutex> lock(this->dataPtr->mutex);
//  return 0;
//}
...
/*
void Ogre2MovableText::getRenderOperation(Ogre::v1::RenderOperation & op)
{
  std::lock_guard<std::recursive_mutex> lock(this->dataPtr->mutex);
...
//////////////////////////////////////////////////
// void Ogre2MovableText::_notifyCurrentCamera(Ogre::Camera *cam)
//{
//  std::lock_guard<std::recursive_mutex> lock(this->dataPtr->mutex);
...
//////////////////////////////////////////////////
//void Ogre2MovableText::_updateRenderQueue(Ogre::RenderQueue* queue)
//{
//  std::lock_guard<std::recursive_mutex> lock(this->dataPtr->mutex);
//  if (this->isVisible())
//  {
...
//////////////////////////////////////////////////
//void Ogre2MovableText::visitRenderables(Ogre::Renderable::Visitor* /*visitor*/,
//                                 bool /*debug*/)
//{
//  std::lock_guard<std::recursive_mutex> lock(this->dataPtr->mutex);
//  return;
