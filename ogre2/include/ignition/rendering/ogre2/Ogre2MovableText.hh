 ...
 *
*/
#ifndef IGNITION_RENDERING_OGRE2_OGRE2MOVABLETEXT_HH_
#define IGNITION_RENDERING_OGRE2_OGRE2MOVABLETEXT_HH_
...
namespace ignition
{
  namespace rendering
  {
    ...
    class Ogre2MovableTextPrivate;

    /*  \class OgreMovableText OgreMovableText.hh \
     *  ignition/rendering/ogre/OgreMovableText.hh
     */
    /// \brief Movable text
    class IGNITION_RENDERING_OGRE2_VISIBLE Ogre2MovableText
      : public Ogre::MovableObject, public Ogre::Renderable
    {
      ...
      /// protected: void getRenderOperation(Ogre::v1::RenderOperation &_op) override;
      ...
      private: std::unique_ptr<Ogre2MovableTextPrivate> dataPtr;
    };
    }
  }
}
